      ...
      <div  class="index">
        ...
        <div class="right" ref="right">
          ...
          <div class="right-main">
            <div style="width: 94%;float: left;margin-left: 3%;height: 50px;line-height: 50px;text-align: center;">
                {{this.FProjectname}}
            </div>
            <el-table
              ref="multipleTable"
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-button :disabled="scope.row.FSTATUS == '已入库'" style="float: left;" @click="handleClick(scope.row)" type="primary" size="medium">确认发料</el-button>
                </template>
              </el-table-column>
            </el-table>
...
<script>
    export default {
      ...
      mounted() {
          this.FProjectname = this.$route.query.FCONTRACTNO
      },
      watch:{
        $route(){
